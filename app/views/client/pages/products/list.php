                ...
                <div class="col-lg-3 col-md-6 col-sm-12 pb-1 js-product-row">
                    <div class="card product-item border-0 mb-4">
                        ...
                        <div class="card-footer d-flex justify-content-center bg-light border">
                            <a href="index.php?act=detail_product&product_id=<?= $product_id ?>&color_id=<?= $color_id ?>" class="btn btn-sm text-dark p-0"><i class="fas fa-eye text-primary mr-1"></i>View Detail</a>
                        </div>
                    </div>
                </div>
        <?php }
