    ...
    <div class="sidebar">
        ...
        <nav class="mt-2">
            <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                ...
                <li class="nav-item">
                    <a href="index.php?act=products" class="nav-link">
                ...
                <li class="nav-item">
                    ...
                    <!-- <ul class="nav nav-treeview">
                        <li class="nav-item">
                            <a href="./app/controllers/admin/form.php" class="nav-link">
                                <i class="far fa-circle nav-icon"></i>
                                <p>Add Comment</p>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="../../../public/assets/pages/layout/collapsed-sidebar.html" class="nav-link">
                                <i class="far fa-circle nav-icon"></i>
                                <p>List Comment</p>
                            </a>
                        </li>
